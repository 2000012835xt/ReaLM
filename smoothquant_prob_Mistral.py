...
if __name__=='__main__':
    ...
    for i in range(len(err_prob_list)):
        ...
        print('loading model')
        # model_fp16_normal = AutoModelForCausalLM.from_pretrained('mistralai/Mistral-7B-v0.1', torch_dtype=torch.float32, device_map='auto')
        ...
        print('smoothing')
        # smooth_lm(model_fp16_normal, act_scales, 0.8)
        ...
        # dataset_x_sum=load_dataset('EdinburghNLP/xsum',split='validation[:700]')
        ...
        # evaluator_x_sum = Evaluator_x_sum(dataset_x_sum,tokenizer,'cuda')
        print('quantizing...')
        ...
        # print("acc_noisy",acc_noisy," ", "ppl_noisy",ppl_noisy," ","x_sum",x_sum)
