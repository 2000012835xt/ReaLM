...
class NoisyW8A8Linear(W8A8Linear):
    ...
    def inject_error(self,y, w_scales, a_scales, err_prob):
        ...
        flip_bit=torch.randint_like(result,0,30)
        ...
        result_injected[mask]=torch.bitwise_xor(result[mask],err[mas])
...
# pdb.set_trace()
tt=torch.nn.Linear(128,128,bias=True)
given_weight=torch.randn(2,128,128)
given_activation=torch.randn(2,128,128)
